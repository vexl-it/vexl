  ...
  it('resolves a pin to the nearest settlement with city context', async () => {
    await runPromiseInMockedEnvironment(
      Effect.gen(function* () {
        ...
        const response = yield* client.getGeocodedCoordinatesV2({
          query: {lang: 'en', ...coordinates(50.076, 14.438)},
        })
  ...
  it('keeps two pins in the same settlement distinct', async () => {
    await runPromiseInMockedEnvironment(
      Effect.gen(function* () {
        ...
        const first = yield* client.getGeocodedCoordinatesV2({
          query: {lang: 'en', ...coordinates(50.0755, 14.4378)},
        })
        const second = yield* client.getGeocodedCoordinatesV2({
          query: {lang: 'en', ...coordinates(50.0765, 14.4392)},
        })
  ...
  it('resolves to a settlement, never to a street or a POI', async () => {
    await runPromiseInMockedEnvironment(
      Effect.gen(function* () {
        ...
        const response = yield* client.getGeocodedCoordinatesV2({
          query: {lang: 'en', ...coordinates(48.1443, 17.1108)},
        })
  ...
  it('localizes the address', async () => {
    await runPromiseInMockedEnvironment(
      Effect.gen(function* () {
        ...
        const response = yield* client.getGeocodedCoordinatesV2({
          query: {lang: 'de', ...coordinates(50.0875, 14.4213)},
        })
      ...
      Effect.gen(function* () {
        ...
        const response = yield* pipe(
          client.getGeocodedCoordinatesV2({
            query: {lang: 'en', ...coordinates(0, -30)},
          }),
          Effect.result
        )
