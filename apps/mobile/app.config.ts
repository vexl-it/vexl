...
export default {
  ...
  'locales': {
    'bg': '../../packages/localization/locales/bg/infoPlist.json',
    'cs': '../../packages/localization/locales/cs/infoPlist.json',
    'de': '../../packages/localization/locales/de/infoPlist.json',
    'en': '../../packages/localization/locales/en/infoPlist.json',
    'es': '../../packages/localization/locales/es/infoPlist.json',
