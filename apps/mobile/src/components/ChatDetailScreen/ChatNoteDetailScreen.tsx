...
import ChatNoteDetailContent from './components/ChatNoteDetailContent'

type Props = RootStackScreenProps<'ChatNoteDetail'>

export default function ChatNoteDetailScreen({
  route: {
  ...
  return (
    <ScopeProvider scope={ChatScope} value={nonNullChatWithMessagesAtom}>
      <ChatNoteDetailContent chatExists={chatExists} />
    </ScopeProvider>
  )
}
