...
import {privateApi} from '@vexl-next/rest-api/src/services/contact'
...
import {apiEnv, platform, privateApiAtom} from '../../api'
...
export default function PhoneNumberHashBugMigration({
  ...
  useEffect(() => {
    ...
    const api = store.get(privateApiAtom)
