...
export const MINIMAL_VERSION_REQUEST_CLUB_ADMITION =
  Schema.decodeSync(VersionString)('1.30.0')
// Only generated by CI (pr-preview.yaml) — keep PREVIEW_LINK_MIN_VERSION
// there in sync with this value.
export const MINIMAL_VERSION_LOAD_PR_PREVIEW =
  Schema.decodeSync(VersionString)('1.44.2')
