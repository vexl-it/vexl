...
export const createNotificationTokens = Effect.flatMap(
  ...
  (sql) => sql`
    ...
    CREATE INDEX IF NOT EXISTS idx_notification_secrets_secret ON notification_token_secrets (secret);

    CREATE INDEX IF NOT EXISTS idx_notification_secrets_expo_token ON notification_token_secrets (expo_notification_token);
