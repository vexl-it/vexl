  ...
  /* JSON starts */
{
  ...
  "loginFlow": {
    ...
    "anonymizationNotice": {
      ...
      "text": "Nikdo neuvidí tvoje skutečné jméno a profilový obrázek, dokud je neodhalíš pro konkrétní obchod. Dokonce i my. Nejprve nastavíme tvoji skutečnou identitu."
    },
    "name": {
      "prompt": "Jak ti říkají kamarádi?",
      "placeholder": "Jméno nebo přezdívka",
      "nameValidationError": "Jméno by mělo mít alespoň 1 znak a maximálně 50 znaků."
    },
    "photo": {
    ...
    "anonymization": {
      ...
      "action": "Anonymizovat",
      "afterDescription": "Takto tě uvidí ostatní uživatelé, než jim odhalíš svůj soukromý profil."
    },
    "phoneNumber": {
      "title": "Jaké je tvoje telefonní číslo?",
      "placeholder": "Telefonní číslo",
      "text": "Abychom vás mohli spojit s komunitou Vexl, musíte zadat své telefonní číslo.",
      "errors": {
        "invalidPhoneNumber": "Neplatné telefonní číslo. Zkus to prosím znovu.",
        "previousCodeNotExpired": "Ověřování tohoto telefonního čísla již probíhá. Počkej prosím, dokud nevyprší jeho platnost."
      }
    },
    "verificationCode": {
      ...
      "errors": {
        ...
        "challengeCouldNotBeGenerated": "Výzvu se nepodařilo vygenerovat. Zkuste to znovu později",
        "verificationNotFound": "Chybný ověřovací kód.",
        "UserNotFound": "Uživatel nebyl nalezen. Zkus kód odeslat znovu.",
        "SignatureCouldNotBeGenerated": "Podpis se nepodařilo vygenerovat. Zkus to znovu později",
        "PublicKeyOrHashInvalid": "Veřejný klíč nebo hash je neplatný. Zkus to znovu později."
      },
      "success": {
        "title": "Tvé číslo bylo ověřeno. [nwln] Čas nastavit tvůj profil.",
        "errorWhileParsingSessionForInternalState": "Chyba při ukládání uživatele"
      }
    },
    "importContacts": {
      "title": "Pojďme nyní najít tvoje přátele!",
      "text": "Vexl používá tvojí reálnou sociální síť - tvoje přátele a jejich přátele. Čím více kontaktů přidáš, tím více nabídek uvidíš.",
  ...
  "postLoginFlow": {
    "contactsExplanation": {
      "title": "Pojďme nyní najít tvoje přátele!",
      "text": "Vexl používá tvojí reálnou sociální síť - tvoje přátele a jejich přátele. Čím více kontaktů přidáte, tím více nabídek uvidíte.",
      "anonymizationCaption": "Tvé kontakty neuvidí nikdo další. Dokonce ani my."
    },
    ...
    "contactsList": {
      ...
      "nothingFound": {
        ...
        "text": "Chceš-li přidat telefonní číslo napřímo, zadej ho do vyhledávacího řádku (s předčíslím země)."
      },
      "toAddCustomContact": "Chceš-li přidat telefonní číslo napřímo, zadej ho do vyhledávacího řádku (s předčíslím země)."
    },
    "allowNotifications": {
      "title": "Povolit notifikace",
      "text": "Díky notifikacím se dozvíš, když ostatní přijmou tvé nabídky nebo když ti přijdou nové zprávy.",
      "action": "Povolit",
      "cancel": "Přeskočit",
      "errors": {
        "permissionDenied": "Notifikace nebyli povoleny. Můžeš je povolit později v nastavení systému.",
  ...
  "settings": {
    ...
    "items": {
      ...
      "allowScreenshotsDescription": "Zakázat uživatelům pořizovat snímky chatu",
    ...
    "noLogoutExplanation": "Chceš se odhlásit? Taková možnost ve Vexlu není - můžeš ale smazat účet.",
    "support": "Pokud se ti Vexl líbí, budeme rádi za tvůj příspěvek v tvrdé měně.",
    "version": "Verze aplikace Vexl: Vxl: {{version}}",
    "logoutDialog": {
      "title": "Smazat účet?",
      "title2": "jsi si jistý ?",
      "description": "Opravdu chcete smazat svůj účet? Tuto akci již nikdy nebudete moci vrátit zpět."
    }
  },
  "offer": {
    "title": "Nabídka",
    ...
    "report": {
      ...
      "areYouSureText": "Skutečně chceš nahlásit tuhle nabídku? Tahle akce je nevratná.",
      "yes": "Ano, nahlásit"
    },
    "goToChat": "Přejděte na chat",
    "requestStatus": {
      "requested": "Byla odeslána žádost o obchodování. Dáme vám vědět, jakmile bude přijata.",
    ...
    "createOfferAndReachVexlers": "Tvůj dosah je {{reachNumber}} vexláků.\nNaimportuj víc kontaktů abys viděl nabídky",
    "filterActive": "Filtr aktivní"
  },
  "termsOfUse": {
    "termsOfUse": "Podmínky používání",
    "privacyPolicy": "Zásady ochrany osobních údajů",
    "dontHaveTime": "Nemáte čas to všechno číst? Podívejte se na často kladené otázky."
  },
  "faqs": {
    "faqs": "Často kladené otázky",
    "whatIsVexl": "Co je to Vexl?",
    "vexlIsPlatform": "Vexl je platforma kde můžeš domlouvat směnu bitcoinu v rámci své reálné sociální sítě - se svými přáteli a přáteli jejich přátel - a přitom zůstat zcela anonymní, pokud si to přeješ.",
    "whoCanSeeMyContacts": "Kdo může vidět mé kontakty?",
    "peopleWhomYouAllowToSee": "Lidé, kterým dovolíš vidět tvou identitu, mohou vidět tvé společné přátele. To je vše.",
    "howCanIRemainAnonymous": "Jak mohu zůstat anonymní a přitom být součástí Vexlu?",
    "byDefaultYouParticipateInTheNetwork": "Ostatní účastníci sítě tě uvidí pod tvým Vexl jménem a avatarem, které ti byly přiděleny při registraci. Svou identitu můžeš odhalit pouze pro konkrétní obchod v našem zabezpečeném, end-to-end šifrovaném chatu.",
    "howCanIMakeSure": "Jak se mohu ujistit, že osoba, se kterou mluvím, je ta, se kterou chci mluvit?",
    "oneChallenge": "Jedním z úskalí skutečně anonymních komunikačních systémů, jako je Vexl, je to, že někdy musíte ověřit totožnost osoby, se kterou komunikujete! V takových případech je nejlepší použít zabezpečený sekundární komunikační kanál, aby jsi si s druhou osobou potvrdil, že jste oba ti, za které se vydáváte.",
    "howCanIEnsure": "Jak se mohu ujistit, že moje komunikace a obchody jsou soukromé a šifrované?",
    "vexlIsOpensource": "Vexl má otevřený zdrojový kód - kdokoli v něm může hledat zadní vrátka nebo škodlivé úmysly. Můžeš se taky podívat na zprávu z nezávislého bezpečnostního auditu.",
    "howCanYouEnsure": "Jak můžete zajistit ochranu mých údajů?",
    "vexlIsDesigned": "Vexl je navržen tak, aby nikdy neshromažďoval ani neukládal žádné citlivé informace. Ke zprávám a dalšímu obsahu nemáme my ani jiné třetí strany přístup, protože jsou vždy šifrovány end-to-end. Naše podmínky poskytování služeb a zásady ochrany osobních údajů jsou k dispozici níže.",
    "howDoIContactVexl": "Jak mohu kontaktovat Vexl ?",
    "youCanAlwaysReachOutToUs": "Vždy se na nás můžeš obrátit prostřednictvím e-mailu: support@vexl.it. Nebo se s námi můžeš setkat během svého příštího P2P obchodu! 😻"
  },
  "offerForm": {
    ...
    "premiumOrDiscount": {
      ...
      "youBuyForTheActualMarketPrice": "Kupuješ za skutečnou tržní cenu. Pohni s posuvníkem a prodávej rychleji nebo vydělej více.",
      "theOptimalPositionForMostPeople": "Optimální pozice pro většinu lidí. Nakupuješ o něco rychleji, ale za trochu vyšší cenu",
      "youBuyReallyFast": "Nakupuješ opravdu rychle, ale hodně nad tržní cenou",
      "youBuyPrettyCheap": "Nakupuješ poměrně levně, ale může trvat o něco déle, než najdeš prodávajícího",
      "youBuyVeryCheaply": "Nakupuješ velmi levně, ale může chvíli trvat, než najdeš prodávajícího",
      "buyFaster": "Nakupuješ rychleji",
      "buyCheaply": "Nakupuješ levně",
      "youSellForTheActualMarketPrice": "Prodáváš za skutečnou tržní cenu. Pohni s posuvníkem a prodávej rychleji nebo vydělávej více.",
      "youEarnBitMore": "Vyděláš o něco více, ale může to trvat o něco déle.",
      "youWantToEarnFortune": "Chceš vydělat majlant, ale může trvat roky, než najdeš kupce.",
      "youSellSlightlyFaster": "Prodáváš o něco rychleji, ale trochu pod tržní cenou.",
      "youSellMuchFaster": "Prodáváš mnohem rychleji, ale hluboko pod tržní cenou",
      ...
      "influenceImpactOfYourSellOffer": "Ovlivni dopad své nabídky. Prodávej rychleji přidáním slevy nebo vydělávej více přidáním bonusu k tržní ceně bitcoinu.",
      "influenceImpactOfYourBuyOffer": "Ovlivni dopad své nabídky. Nakupuj rychleji přidáním slevy nebo nakupuj více přidáním bonusu k tržní ceně bitcoinu.",
      "playWithItAndSee": "Pohni posuvníkem a zjisti, jak to ovlivní zájem ostatních.",
      "plus": "+",
      "minus": "-"
    },
    "buyCheaperByUsingDiscount": "Nakup levněji použitím slevy nebo nakup rychleji přidáním prémia k tržní ceně bitcoinu.",
    "sellFasterWithDiscount": "Prodávej rychleji pomocí slevy nebo vydělej více přidáním prémia k tržní ceně bitcoinu.",
    "location": {
      "location": "Lokalita",
      "meetingInPerson": "Osobní setkání je bezpečnější. Na co si dát pozor u online obchodů?",
      "checkItOut": "Podívej se na to",
      "addCityOrDistrict": "Přidejte město nebo okres",
      "whatToWatchOutForOnline": "Na co si dát pozor online?",
      "moneySentByRandomPerson": "Peníze zaslané náhodnou osobou mohou mít kriminální původ a mohou být vystopovatelné.",
      "neverSendCrypto": "Nikdy neposílejte bitcoin před obdržením platby.",
      "alwaysVerifyTheName": "Vždy si ověř jméno majitele účtu, od kterého jsi platbu obdržel, jestli sedí s deklarovanou identitou protistrany.",
      "forwardTheAddress": "Adresu předej bezpečným způsobem a nezapomeň ji ověřit jiným bezpečným kanálem."
    },
    "inPerson": "Osobně",
    "online": "Online",
    "paymentMethod": {
    ...
    "network": {
      "network": "Síť",
      "lightning": "Lightning",
      "theBestOption": "Nejlepší volba pro opravdu malé částky. Obvykle super rychlá.",
      "onChain": "On chain",
      "theBestFor": "Lepší pro poměrně velké částky. Může to trvat déle."
    },
    "description": {
      "description": "Popis",
      "writeWhyPeopleShouldTake": "Napište, proč by lidé měli vaši nabídku přijmout."
    },
    "friendLevel": {
    ...
    "errorSearchingForAvailableLocation": "Chyba při vyhledávání dostupných míst",
    "offerEncryption": {
      "encryptingYourOffer": "Šifrování nabídky ...",
      "dontShutDownTheApp": "Během šifrování nevypínejte aplikaci. Může to trvat několik minut.",
      "forVexlers": "pro {{count}} vexláků",
      "doneOfferPoster": "Hotovo! Nabídka odeslána.",
      "yourFriendsAndFriendsOfFriends": "Tví přátelé a přátelé jejich přátel nyní mohou vidět tvoji nabídku.",
      "anonymouslyDeliveredToVexlers": "Anonymně doručeno pro {{count}} vexláků"
    },
    "noVexlersFoundForYourOffer": "Pro tvoji nabídku nebyl nalezen žádný vexlák",
  ...
  "editOffer": {
    ...
    "youCanCheckYourOffer": "Svou nabídku můžeš zkontrolovat v sekci Moje nabídky",
    ...
    "deleteOfferDescription": "Opravdu chcete smazat nabídku? Tuto akci již nikdy nebudete moci vrátit zpět."
  },
  "filterOffers": {
  ...
  "messages": {
    ...
    "isBuying": "kupuje",
    "isSelling": "prodává",
    "thisWillBeYourFirstInteraction": "Toto bude tvoje první interakce s touto nabídkou.",
    "wellLetYouKnowOnceUserAccepts": "Žádost byla odeslána. Dáme ti vědět, jakmile druhá strana odpoví.",
    "messagePreviews": {
      "incoming": {
    ...
    "deleteChatExplanation1": "Skončili jste s obchodováním? Ukončení chatu znamená, že vaše konverzace bude trvale smazána.",
    "deleteChatExplanation2": "Tento krok je nevratný.",
    "blockChatExplanation1": "Opravdu chceš uživatele zablokovat? Tento krok nejde vrátit zpět. Dobře si to rozmysli.",
    "blockChatExplanation2": "Opravdu chceš uživatele zablokovat? Tento krok nejde vrátit zpět. Dobře si to rozmysli.",
    ...
    "identityRevealRequestModal": {
      ...
      "text": "Odesláním žádosti o odhalení identity souhlasíš i s odhalením své identity.",
      "send": "Odeslat žádost"
    },
    "identityRevealRespondModal": {
      "title": "Chceš odhalit identitu? ",
      "text": "Pokud odhalíš svou identitu, zobrazí se také identita protistrany."
    },
    "identityAlreadyRequested": "V konverzaci již byl odeslán požadavek na zjištění identity",
  ...
  "progressBar": {
    ...
    "CONSTRUCTING_PUBLIC_PAYLOAD": "Sestavení a zašifrování veřejného užitečného zatížení",
  ...
  "AppLogs": {
    ...
    "warning": "Zapnutí logování může negativně ovlivnit rychlost aplikace a zabere více místa na zařízení",
    "anonymizeAlert": {
