  ...
  /* JSON starts */
{
  "common": {
    ...
    "networkErrors": {
      "errNetwork": "A network error has occurred. Are you connected to the internet?",
  ...
  "loginFlow": {
    ...
    "anonymizationNotice": {
      ...
      "text": "Nobody will see your real name and profile picture until you reveal it for particular trade. Not even us. Let’s set up your true identity first."
    },
    "name": {
      "prompt": "What do your friends call you?",
      "placeholder": "Name or nickname",
      "nameValidationError": "Name should be at least 1 characters long and maximum 50 characters long"
    },
    "photo": {
    ...
    "anonymization": {
      ...
      "action": "Anonymize",
      "afterDescription": "This is how other users will see you until you reveal your real identity."
    },
    "phoneNumber": {
      "title": "What’s your phone number?",
      "placeholder": "Phone number",
      "text": "In order to connect you with the Vexl community, enter your phone number",
      "errors": {
        "invalidPhoneNumber": "Invalid phone number. Please try again.",
        "previousCodeNotExpired": "Verification for this phone number is already in progress. Please wait until it expires"
      }
    },
    "verificationCode": {
      ...
      "errors": {
        ...
        "challengeCouldNotBeGenerated": "Challenge could not be generated. Try again later",
        "verificationNotFound": "Verification code wrong.",
        "UserNotFound": "User not found. Try to resend the code.",
        "SignatureCouldNotBeGenerated": "Signature could not be generated. Try again later",
    ...
    "importContacts": {
      ...
      "text": "Vexl is using your real-world social network - your friends and their friends. The more contacts you add, the more offers you’ll see.",
  ...
  "postLoginFlow": {
    ...
    "contactsList": {
      ...
      "nothingFound": {
        ...
        "text": "To add phone number directly, type it into a search bar (with country code prefix)."
      },
      "toAddCustomContact": "To add phone number directly type it into a search bar (with country code)"
    },
    "allowNotifications": {
      "title": "Allow notification permissions",
      "text": "Enabling notifications lets you know when others accept your offers or when messages arrive.",
      "action": "Allow",
      "cancel": "Skip",
      "errors": {
        "permissionDenied": "Permissions not granted. You can allow them later in the system settings.",
  ...
  "settings": {
    ...
    "items": {
      ...
      "allowScreenshotsDescription": "Prevent users from taking screenshots of the chat",
    ...
    "noLogoutExplanation": "Can't find logout? There's no such thing.\nBut you can delete your account.",
    "support": "If you like Vexl, support it’s improvement by sending some bitcoin as donation!",
  ...
  "offer": {
    ...
    "offerNotFound": "Offer not found. It might have been deleted by the author",
    "inputPlaceholder": "e.g. let’s trade my friend...",
    "sendRequest": "Send Request",
    "report": {
      "areYouSureTitle": "Report offer?",
      "areYouSureText": "Are you certain about reporting this offer? Once reported, it cannot be undone. Choose wisely.",
      "yes": "Yes, report"
    },
    "goToChat": "Go to chat",
    "requestStatus": {
      "requested": "You've requested a trade. We'll notify you once it's accepted.",
      "accepted": "Your request was accepted.",
      "denied": "Your request was declined."
    },
    "listEmpty": "Your marketplace is just warming up. Come back in a couple of minutes! ",
    "emptyAction": "Add new offer",
    "createOfferAndReachVexlers": "You reach {{reachNumber}} vexlers.\nAdd more contacts to increase the number of offers you see.",
    "filterActive": "Filter active"
  },
  "termsOfUse": {
    "termsOfUse": "Terms of Use",
    "privacyPolicy": "Privacy Policy",
    "dontHaveTime": "Don’t have a time to read all this? Take a look on Frequently Asked Questions."
  },
  "faqs": {
    "faqs": "Frequently Asked Questions",
    "whatIsVexl": "What is Vexl?",
    "vexlIsPlatform": "Vexl is a platform where you can trade Bitcoin within your real world social network - your friends and friends of their friends - while staying completely anonymous - if you wish.",
    "whoCanSeeMyContacts": "Who can see my contacts?",
    "peopleWhomYouAllowToSee": "People whom you allow to see your identity can see the friends you have in common and that's all.",
    "howCanIRemainAnonymous": "How can I remain anonymous and still participate in Vexl? ",
    "byDefaultYouParticipateInTheNetwork": "By default, you participate in the network under your Vexl name and Vexl avatar that were given to you during the registration. You can only reveal your identity per a particular trade in our secure, end to end encrypted chat.",
    "howCanIMakeSure": "How can I make sure that the person I am talking to is the person I want to talk to?",
    "oneChallenge": "One challenge with truly anonymous communications systems like Vexl is that sometimes you do need to verify the identity of the person you’re talking to! In cases like these, it’s best to use a secure secondary channel of communication to confirm with the other person that you’re both who you say you are.",
    "howCanIEnsure": "How can I ensure that my communication and trades are private and encrypted? ",
    "vexlIsOpensource": "Vexl is open source - anyone can look for any backdoor or malicious intent. Also, here you can look at the report from an independent Security Audit .",
    "howCanYouEnsure": "How can you ensure that my data is protected?",
    "vexlIsDesigned": "Vexl is designed to never collect or store any sensitive information. Vexl messages and other content cannot be accessed by us or other third parties because they are always end-to-end encrypted, private, and secure. Our Terms of Service and Privacy Policy are available below.",
    "howDoIContactVexl": "How do I contact Vexl?",
    "youCanAlwaysReachOutToUs": "You can always reach out to us via email: support@vexl.it. For a private comms, you can also send us an e2ee mail. Or you can meet us during your next P2P trade! 😻"
  },
  "offerForm": {
    ...
    "premiumOrDiscount": {
      ...
      "youBuyForTheActualMarketPrice": "You buy for the actual market price. Play with the slider to sell faster or earn more.",
      "theOptimalPositionForMostPeople": "The optimal position for most people. You buy slightly faster, but a bit overpriced",
      "youBuyReallyFast": "You buy quickly, but at much above the market price",
      "youBuyPrettyCheap": "You buy pretty cheap, but it can take slightly longer to find a seller",
      "youBuyVeryCheaply": "You buy very cheaply, but it can take a while to find seller",
      "buyFaster": "Buy quickly",
      "buyCheaply": "Buy cheaply",
      "youSellForTheActualMarketPrice": "You sell for the actual market price. Play with the slider to sell faster or earn more.",
      "youEarnBitMore": "You earn a bit more, but it can take slightly longer.",
      "youWantToEarnFortune": "You want to earn a fortune, but it can take years to find a buyer.",
      ...
      "influenceImpactOfYourSellOffer": "Influence the impact of your offer. Sell faster by adding a discount, or earn more by adding a premium to the Bitcoin market price.",
      "influenceImpactOfYourBuyOffer": "Influence the impact of your offer. Buy cheaply by adding a discount, or buy faster by adding a premium to the bitcoin market price.",
      "playWithItAndSee": "Play with it and see how it affects the interest of others.",
      "plus": "+",
      "minus": "-"
    },
    "buyCheaperByUsingDiscount": "Buy cheaper by using a discount or buy faster by adding a premium to the bitcoin market price",
    "sellFasterWithDiscount": "Sell faster with a discount or earn more by adding a premium to the bitcoin market price.",
    "location": {
      "location": "Location",
      "meetingInPerson": "Meeting in person is safer. What to watch out for online?",
      "checkItOut": "Check it out",
      "addCityOrDistrict": "Add city, or district",
      "whatToWatchOutForOnline": "What to watch out for online?",
      "moneySentByRandomPerson": "Money sent by a random person can be of criminal origin and traceable.",
      "neverSendCrypto": "Never send bitcoin before receiving payment.",
      "alwaysVerifyTheName": "Always verify the name of the account holder you received the payment from with the declared identity of the counterparty.",
      "forwardTheAddress": "Forward the address in a secure manner and be sure to verify it through another secure channel."
    },
    "inPerson": "In person",
    "online": "Online",
    "paymentMethod": {
    ...
    "network": {
      "network": "Network",
      "lightning": "Lightning",
      "theBestOption": "The best option for really small amounts. Usually super fast.",
      "onChain": "On chain",
    ...
    "errorSearchingForAvailableLocation": "Error when searching for available locations",
    "offerEncryption": {
      "encryptingYourOffer": "Encrypting your offer ...",
      "dontShutDownTheApp": "Don’t shut down the app while encrypting. It can take several minutes.",
      "forVexlers": "for {{count}} vexlers",
      "doneOfferPoster": "Done! Offer posted.",
      "yourFriendsAndFriendsOfFriends": "Your friends and friends of their friends can now see your offer.",
      "anonymouslyDeliveredToVexlers": "Anonymously delivered to {{count}} vexlers"
    },
  ...
  "editOffer": {
    ...
    "deleteOfferDescription": "Are you sure you want to delete this offer? This action cannot be undone"
  },
  "filterOffers": {
  ...
  "messages": {
    ...
    "isBuying": "is buying",
    "isSelling": "is selling",
    "thisWillBeYourFirstInteraction": "This will be your first interaction with this offer.",
    "wellLetYouKnowOnceUserAccepts": "Request sent. We will let you know once other side has responded.",
    "messagePreviews": {
      "incoming": {
    ...
    "yesBlock": "Yes, block",
    "deleteChatExplanation1": "Are you done trading? Closing chat means that your conversation will be permanently deleted.",
    "deleteChatExplanation2": "This is definitive step, please confirm this action once again to delete the chat.",
    "blockChatExplanation1": "Do you really want to block this user? You will never be able to undo this action. Choose wisely.",
    "blockChatExplanation2": "Do you really want to block this user? You will never be able to undo this action. Choose wisely.",
    ...
    "identityAlreadyRequested": "Identity request was already sent in the conversation",
  ...
  "AppLogs": {
    ...
    "warning": "Enabling app logs may cause app to be slower and will require more storage space.",
    "anonymizeAlert": {
  ...
  "deepLinks": {
    "importContacts": {
      "alert": {
        ...
        "text": "Do you want to import {{contactName}} with number {{contactNumber}}?"
      },
      "successAlert": {
