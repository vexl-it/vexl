  ...
  /* JSON starts */
{
  ...
  "loginFlow": {
    ...
    "anonymizationNotice": {
      ...
      "text": "Nikto neuvidí tvoje skutočné meno a profilový obrázok, kým ho neodhalíš pre konkrétny obchod. Dokonca aj my. Najprv nastavíme tvoju skutočnú identitu."
    },
    "name": {
      "prompt": "Ako ti vravia kamaráti?",
      "placeholder": "Meno alebo prezývka",
      "nameValidationError": "Meno by malo mať aspoň 1 znak a maximálne 50 znakov"
    },
    "photo": {
    ...
    "anonymization": {
      ...
      "action": "Anonymizovať",
      "afterDescription": "Takto ťa uvidia ostatní užívatelia, než im odhalíš svoj súkromný profil."
    },
    "phoneNumber": {
      "title": "Aké je tvoje telefónne číslo?",
      "placeholder": "Telefónne číslo",
      "text": "Aby sme vás mohli spojiť s komunitou Vexl, musíte zadať svoje telefónne číslo.",
      "errors": {
        "invalidPhoneNumber": "Neplatné telefónne číslo. Skús to prosím znovu.",
        "previousCodeNotExpired": "Overovanie tohto telefónneho čísla už prebieha. Počkaj, prosím, kým nevyprší jeho platnosť."
      }
    },
    "verificationCode": {
      ...
      "errors": {
        ...
        "challengeCouldNotBeGenerated": "Výzvu nebolo možné vygenerovať. Skúste to znova neskôr",
        "verificationNotFound": "Overovací kód je nesprávny.",
        "UserNotFound": "Používateľ nebol nájdený. Skús kód poslať znova.",
        "SignatureCouldNotBeGenerated": "Podpis sa nepodarilo vygenerovať. Skús to znova neskôr.",
        "PublicKeyOrHashInvalid": "Verejný kľúč alebo hash je neplatný. Skús to znova neskôr"
      },
      "success": {
        "title": "Tvoje číslo bolo overené. [nwln] Čas nastaviť tvoj profil.",
        "errorWhileParsingSessionForInternalState": "Chyba pri ukladaní používateľa"
      }
    },
    "importContacts": {
      "title": "Poďme nájsť tvojich priateľov!",
      "text": "Vexl používa tvoju reálnu sociálnu sieť - tvojich priateľov a ich priateľov. Čím viac kontaktov pridáš, tým viac ponúk uvidíš.",
  ...
  "postLoginFlow": {
    "contactsExplanation": {
      ...
      "text": "Vexl používa tvoju reálnu sociálnu sieť - tvojich priateľov a ich priateľov. Čím viac kontaktov pridáš, tým viac ponúk uvidíš.",
      "anonymizationCaption": "Tvoje kontakty neuvidí nikto ďalší. Dokonca ani my."
    },
    ...
    "contactsList": {
      ...
      "nothingFound": {
        ...
        "text": "Ak chceš pridať telefónne číslo napriamo, zadaj ho do vyhľadávacieho riadku (s predvoľbou krajiny)."
      },
      "toAddCustomContact": "Ak chceš pridať telefónne číslo napriamo, zadaj ho do vyhľadávacieho riadku (s predvoľbou krajiny)."
    },
    "allowNotifications": {
      "title": "Povoliť notifikácie",
      "text": "Vďaka notifikáciam sa dozvieš, keď niekto prijme tvoju ponuku, alebo ti príde nová správa.",
      "action": "Povoliť",
      "cancel": "Preskočiť",
      "errors": {
        "permissionDenied": "Notifikácie neboli povolené. Môžeš ich povoliť pozdejšie v nastavení systému.",
  ...
  "settings": {
    ...
    "noLogoutExplanation": "Chceš sa odhlásiť? Taká možnosť vo Vexli nie je - môžeš ale vymazať účet.",
    "support": "Ak se ti Vexl páči, budeme radi za tvoj príspevok v tvrdej mene.",
    "version": "Verzia aplikácie Vexl: Vxl: {{version}}",
    "logoutDialog": {
      "title": "Vymazať účet?",
      "title2": "Si si istý?",
      "description": "Naozaj chcete vymazať svoj účet? Túto akciu už nikdy nebudete môcť vrátiť späť."
    }
  },
  "offer": {
    "title": "Ponuka",
    ...
    "report": {
      ...
      "areYouSureText": "Skutočne chcete nahlásiť túto ponuku? Táto akcia je nevratná.",
      "yes": "Áno, nahlásiť"
    },
    "goToChat": "Prejdite do chatu",
    "requestStatus": {
      "requested": "Bola odoslaná žiadosť o obchodovanie. Po jej prijatí vám dáme vedieť.",
    ...
    "createOfferAndReachVexlers": "Tvoj dosah je {{reachNumber}} vexlákov.\nNaimportuj viac kontaktov, aby si videl viac ponúk",
    "filterActive": "Filter aktívny"
  },
  "termsOfUse": {
    "termsOfUse": "Podmienky používania",
    "privacyPolicy": "Zásady ochrany osobných údajov",
    "dontHaveTime": "Nemáte čas to všetko čítať? Pozrite sa na často kladené otázky."
  },
  "faqs": {
    "faqs": "Často kladené otázky",
    "whatIsVexl": "Čo je to Vexl?",
    "vexlIsPlatform": "Vexl je platforma kde môžeš dohadovať zmenu bitcoinu v rámci svojej reálnej sociálnej siete - so svojimi priateľmi a priateľmi ich priateľov - a pritom zostať úplne anonymný, pokiaľ si to praješ.",
    "whoCanSeeMyContacts": "Kto môže vidieť moje kontakty?",
    "peopleWhomYouAllowToSee": "Ľudia, ktorým dovolíš vidieť svoju identitu, môžu vidieť vaších spoločných priateľov. To je všetko.",
    "howCanIRemainAnonymous": "Ako môžem zostať anonymný a pritom byť súčasťou Vexlu?",
    "byDefaultYouParticipateInTheNetwork": "Ostatní účastníci siete ťa uvidia pod tvojim Vexl menom a avatarom, ktoré ti boli pridelené pri registrácii. Svoju identitu môžeš odhaliť iba pre konkrétny obchod v našom zabezpečenom, end-to-end šifrovanom chate.",
    "howCanIMakeSure": "Ako sa môžem uistiť, že osoba, s ktorou sa bavím, je ta, s ktorou sa chcem baviť?",
    "oneChallenge": "Jedným z úskalí skutočne anonymných komunikačných systémov, ako je Vexl, je to, že si niekedy musíte overiť totožnosť osoby, s ktorou komunikujete! V takýchto prípadoch je najlepšie použiť zabezpečený sekundárny komunikačný kanál, aby si si s druhou osobou potvrdil, že ste obaja tí, za ktorých sa vydávate.",
    "howCanIEnsure": "Ako sa môžem uistiť, že moja komunikácia a obchody sú súkromné a šifrované?",
    "vexlIsOpensource": "Vexl má otvorený zdrojový kod - ktokoľvek v ňom môže hľadať zadné vrátka alebo škodlivé úmysly. Môžeš sa tiež pozrieť na správu z nezávislého bezpečnostného auditu.",
    "howCanYouEnsure": "Ako môžete zaistiť ochranu mojich údajov?",
    "vexlIsDesigned": "Vexl je navrhnutý tak, aby nikto nezhromažďoval ani neukládal žiadne citlivé informácie. K správam a ďalšiemu obsahu nemáme my ani iné tretie strany prístup, pretože sú vždy šifrované end-to-end. Naše podmienky poskytovania služieb a zásady ochrany osobných údajov sú k dispozícii nižšie.",
    "howDoIContactVexl": "Ako môžem kontaktovať Vexl ?",
    "youCanAlwaysReachOutToUs": "Vždy sa na nás môžeš obrátiť prostredníctvom e-mailu: support@vexl.it. Alebo sa s nami môžeš stretnúť počas svojho budúceho P2P obchodu! 😻"
  },
  "offerForm": {
    ...
    "premiumOrDiscount": {
      ...
      "youBuyForTheActualMarketPrice": "Kupuješ za skutočnú trhovú cenu. Pohni s posuvníkom, aby ste predával rýchlejšie alebo zarobil viac.",
      "theOptimalPositionForMostPeople": "Optimálna pozícia pre väčšinu ľudí. Nakupuješ o niečo rýchlejšie, ale za trochu vyššiu cenu",
      "youBuyReallyFast": "Nakupujete naozaj rýchlo, ale o hodne nad trhovú cenu",
      "youBuyPrettyCheap": "Kupuješ pomerne lacno, ale môže trvať o niečo dlhšie, kým nájdeš predávajúceho",
      "youBuyVeryCheaply": "Nakupuješ veľmi lacno, ale môže chvíľu trvať, kým nájdeš predávajúceho",
      "buyFaster": "Nakupuješ rýchlejšie",
      "buyCheaply": "Nakupuješ lacno",
      "youSellForTheActualMarketPrice": "Predávaš za skutočnú trhovú cenu. Pohni s posuvníkom, aby si predával rýchlejšie alebo zarobil viac.",
      "youEarnBitMore": "Zarábaš o niečo viac, ale môže to trvať o niečo dlhšie.",
      "youWantToEarnFortune": "Chceš zarobiť veľa, ale môže trvať roky, kým nájdeš kupcu.",
      "youSellSlightlyFaster": "Predávaš o niečo rýchlejšie, ale trochu pod trhovou cenou",
      "youSellMuchFaster": "Predávaš oveľa rýchlejšie, ale hlboko pod trhovou cenou",
      ...
      "influenceImpactOfYourSellOffer": "Ovplyvni dosah svojej ponuky. Predaj rýchlejšie pridaním zľavy alebo zarob viac pridaním prémia k trhovej cene bitcoinu.",
      "influenceImpactOfYourBuyOffer": "Ovplyvni dosah svojej ponuky. Nakupuj rýchlejšie pridaním zľavy alebo nakupuj viac pridaním prémia k trhovej cene bitcoinu.",
      "playWithItAndSee": "Pohni posuvníkom a zisti, ako to ovplyvní záujem ostatných.",
      "plus": "+",
      "minus": "-"
    },
    "buyCheaperByUsingDiscount": "Nakúp lacnejšie použitím zľavy alebo nakúp rýchlejšie pridaním prémia k trhovej cene bitcoinu",
    "sellFasterWithDiscount": "Predávaj rýchlejšie pomocou zľavy alebo zarob viac pridaním prémia k trhovej cene bitcoinu.",
    "location": {
      "location": "Lokalita",
      "meetingInPerson": "Osobné stretnutie je bezpečnejšie. Na čo si dať pozor pri online obchodoch? ",
      "checkItOut": "Pozri sa na to",
      "addCityOrDistrict": "Pridať mesto alebo okres",
      "whatToWatchOutForOnline": "Na čo si dať pozor online?",
      "moneySentByRandomPerson": "Peniaze poslané náhodnou osobou môžu mať kriminálny pôvod a dajú sa vystopovať.",
      "neverSendCrypto": "Nikdy neposielajte bitcoin pred prijatím platby.",
      "alwaysVerifyTheName": "Vždy si over meno majiteľa účtu, od ktorého si platbu prijal, či sedí s deklarovanou identitou protistrany.",
      "forwardTheAddress": "Adresu preposielaj bezpečným spôsobom a nezabudnite ju overiť iným bezpečným kanálom."
    },
    "inPerson": "Osobne",
    "online": "Online",
    "paymentMethod": {
    ...
    "network": {
      "network": "Sieť",
      "lightning": "Lightning",
      "theBestOption": "Najlepšia možnosť pre malé sumy. Zvyčajne super rýchla.",
      "onChain": "On chain",
      "theBestFor": "Lepšia pre pomerne veľké sumy. Môže to trvať dlhšie."
    },
    "description": {
      "description": "Popis",
      "writeWhyPeopleShouldTake": "Napíšte, prečo by ľudia mali prijať vašu ponuku."
    },
    "friendLevel": {
    ...
    "errorSearchingForAvailableLocation": "Chyba pri vyhľadávaní dostupných miest",
    "offerEncryption": {
      "encryptingYourOffer": "Šifrovanie ponuky ...",
      "dontShutDownTheApp": "Počas šifrovania nevypínajte aplikáciu. Môže to trvať niekoľko minút.",
      "forVexlers": "pre {{count}} vexlákov",
      "doneOfferPoster": "Hotovo! Ponuka odoslaná.",
      "yourFriendsAndFriendsOfFriends": "Tvoju ponuku teraz môžu vidieť tvoji priatelia a priatelia ich priateľov.",
      "anonymouslyDeliveredToVexlers": "Anonymne doručené pre {{count}} vexlákov"
    },
    "noVexlersFoundForYourOffer": "Pre tvoju ponuku neboli nájdení žiadni vexláci",
  ...
  "editOffer": {
    ...
    "offerUnableToChangeOfferActivation": "Nie je možné zmeniť aktiváciu ponuky",
    "editingYourOffer": "Úprava ponuky ...",
    "pleaseWait": "Počkaj prosím",
    "offerEditSuccess": "Úprava prebehla úspešne",
    "youCanCheckYourOffer": "Svoju ponuku si môžeš skontrolovať v časti Moje ponuky",
    ...
    "deleteOfferDescription": "Naozaj chcete vymazať svoju ponuku? Túto akciu nie je možné vrátiť späť."
  },
  "filterOffers": {
  ...
  "messages": {
    ...
    "isBuying": "kupuje",
    "isSelling": "predáva",
    "thisWillBeYourFirstInteraction": "Toto bude tvoja prvá interakcia s touto ponukou.",
    "wellLetYouKnowOnceUserAccepts": "Žiadosť odoslaná. Dáme ti vedieť, keď druhá strana odpovie.",
    "messagePreviews": {
      "incoming": {
    ...
    "deleteChatExplanation1": "Skončili ste s obchodovaním? Ukončenie chatu znamená, že vaša konverzácia bude natrvalo vymazaná.",
    "deleteChatExplanation2": "Toto je definitívny krok, prosím, potvrďte túto akciu ešte raz, aby bola skutočná.",
    "blockChatExplanation1": "Naozaj chceš užívateľa zablokovať? Tento krok nejde vrátiť späť. Dobre si to rozmysli.",
    "blockChatExplanation2": "Naozaj chceš užívateľa zablokovať? Tento krok nejde vrátiť späť. Dobre si to rozmysli.",
    ...
    "identityRevealRequestModal": {
      ...
      "text": "Odoslaním žiadosti o odhalenie identity súhlasíš aj s odhalením tvojej identity.",
    ...
    "identityAlreadyRequested": "V konverzácii už bola odoslaná žiadosť o zistenie identity",
  ...
  "progressBar": {
    ...
    "CONSTRUCTING_PUBLIC_PAYLOAD": "Konštruovanie a šifrovanie verejného užitočného zaťaženia",
  ...
  "AppLogs": {
    ...
    "warning": "Povolenie zaznamenávania aplikačných logov môže zapríčíniť spomalenie aplikácie a zaberať väčší priestor na disku.",
    "anonymizeAlert": {
      "title": "Would you like to anonymize logs?",
      "text": "We can try to strip private keys and personal information from logs before exporting them. Always make sure to verify by yourself."
    }
  },
  "MaintenanceScreen": {
  ...
  "deepLinks": {
    "importContacts": {
      "alert": {
        ...
        "text": "Chcete importovať {{contactName}} s číslom {{contactNumber}}?"
      },
      "successAlert": {
